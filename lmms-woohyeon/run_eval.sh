...
python3 -m accelerate.commands.launch \
    ...
    --wandb_args "project=llava1.6_recursive_eval_woohye0n,entity=VLM_Hallucination_Woohyeon,name=llava-v1.6-7b-168-recursion-0.1"
...
python3 -m accelerate.commands.launch \
    ...
    --verbosity DEBUG \
    --positional_embedding_type reduced \
    --wandb_args "project=llava1.6_recursive_eval_woohye0n,entity=VLM_Hallucination_Woohyeon,name=llava-v1.6-7b-168-recursion-0.3"
...
python3 -m accelerate.commands.launch \
    ...
    --verbosity DEBUG \
    --positional_embedding_type reduced \
    --wandb_args "project=llava1.6_recursive_eval_woohye0n,entity=VLM_Hallucination_Woohyeon,name=llava-v1.6-7b-168-recursion-0.0"
...
python3 -m accelerate.commands.launch \
    ...
    --verbosity DEBUG \
    --positional_embedding_type reduced \
    --wandb_args "project=llava1.6_recursive_eval_woohye0n,entity=VLM_Hallucination_Woohyeon,name=llava-v1.6-7b-168-reduced"
...
python3 -m accelerate.commands.launch \
    ...
    --wandb_args "project=llava1.6_recursive_eval_woohye0n,entity=VLM_Hallucination_Woohyeon,name=llava-v1.6-7b-168-zero"
...
python3 -m accelerate.commands.launch \
    ...
    --regenerate_condition all \
    --verbosity DEBUG \
    --positional_embedding_type interpolate \
    --wandb_args "project=llava1.6_recursive_eval_woohye0n,entity=VLM_Hallucination_Woohyeon,name=llava-v1.6-7b-168-interpolate"