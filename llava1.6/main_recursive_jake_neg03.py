...
def run():
    ...
    for img_idx, i in enumerate(range(len(dataset))):
        ...
        for cat_idx, cat_name in enumerate(predict_list):
            ...
            prompt_text = f"Does there exist {cat_name} in the image? Answer in the format of only 'Yes, there is not {cat_name} in the image.'' or 'No, there is not {cat_name} in the image.'"
            ...
            ##################### 2nd Stage ##########################
            print(f'2nd stage-> ret_atten[1].shape: {ret_attn[5].shape}')
            ...
            with open(f"/home/aidas_intern_1/woohyeon/llava1.6/jake_result/jake_2stage_neg_prompt.csv", "a") as f:
